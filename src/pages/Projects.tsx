...
const Projects: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col overflow-hidden">
      ...
      {/* Main content - centered with adjusted padding and added right margin */}
      <main className="flex-grow w-full md:pl-60 lg:pl-64 pt-20 md:pt-8 px-4 md:px-8 max-w-full overflow-x-hidden">
