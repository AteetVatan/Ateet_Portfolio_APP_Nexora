...
const FALLBACK_ABOUT_CONTENT: AboutContent = {
  ...
  tagline: "Building deterministic, auditable AI platforms — multi-agent workflows, RAG pipelines, and LLM-driven automation built for real-world reliability.",
  bio: `I'm Ateet Bahamani, an AI Architect / Agentic AI Engineer based in Essen, Germany. I design and ship deterministic, auditable AI platforms — multi-agent workflows, RAG pipelines, and LLM-driven automation built for real-world reliability, not "demo-day vibes."

Right now, I'm building execution-driven agent systems where you can clearly answer:
• What did the system do?
• Why did it do it?
• Which model/tool/data influenced the outcome?
• How confident is it — and what failed safely when things went wrong?

At the architecture level, I obsess over the stuff that makes agentic systems usable in production: execution order, context propagation, budget control, fault isolation, confidence scoring, and multi-model validation — so your system behaves like software, not a dice roll.

My work blends hands-on Python engineering with system design:
**Backend & AI infra:** Python, FastAPI, Pydantic, async patterns
...
• Evaluation & quality controls (so you can measure reliability, not guess it)
• Observability & tracing (so debugging isn't a horror movie)
